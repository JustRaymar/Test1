				...
				if ($res->num_rows>0) {
					while ($row=$res->fetch_assoc()) {
						...
						<tr class='pending'>
							...
							<td class='orderdisp'>x".$row['Quantity']."</td>
							<td class='orderdisp'>₱".$row['OrderPrice']."</td>
							<td><button onclick=\"window.location.href='MENUSellerStart.php';\" class='checkout-button'>Start Order</button></td>
						</tr>";
